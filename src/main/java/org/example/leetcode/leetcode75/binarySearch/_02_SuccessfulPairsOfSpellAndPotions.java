...
//1 <= success <= 10^10
public class _02_SuccessfulPairsOfSpellAndPotions {
    ...
    // Helper function to count successful pairs using binary search
    ...
    public static void main(String[] args) {
        _02_SuccessfulPairsOfSpellAndPotions sol = new _02_SuccessfulPairsOfSpellAndPotions();
        int[] spells = {5, 1, 3};
        ...
        System.out.println(Arrays.toString(result));  // Output: [2, 0, 2]
    }
}
