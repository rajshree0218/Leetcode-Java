package org.example.leetcode.leetcode75.queue;
...
public class _02_Dota2Senate {
    public String predictPartyVictory(String senate) {
        Queue<Integer> radiantQueue = new LinkedList<>();
        Queue<Integer> direQueue = new LinkedList<>();

        // Fill the queues with the indices of the senators from each party
        ...
        // The winner is the party with remaining senators
        return radiantQueue.isEmpty() ? "Dire" : "Radiant";
    }

    public static void main(String[] args) {
        _02_Dota2Senate solution = new _02_Dota2Senate();
